...
export const LocalPublicQueueDisplay = () => {
  const { queueSummary, isLoading } = useLocalQueue();
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-white/90 drop-shadow">
            Выберите развлечение с минимальным временем ожидания!
          </p>
          <div className="text-lg text-white/80 mt-2">
            📡 Локальная сеть - данные синхронизируются в реальном времени
          </div>
        </div>
